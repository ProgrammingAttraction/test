...
import all_games from "../../assets/games.png";
import slot_games from "../../assets/slot.png";
import table_games from "../../assets/table.png";
import roulette_games from "../../assets/roulette.png";
import scratch_card from "../../assets/card.png";
import fishing_games from "../../assets/fishing.png";
import pocker_games from "../../assets/pocker.png";
import video_pocker from "../../assets/video_pocker.png";
import crash_games from "../../assets/crash.png";
...
import casino_games from "../../assets/chip.png";
import instant_games from "../../assets/instant.png";
import famous_games from "../../assets/famous.png";
...
const CategoryItem = ({ item, index, selectedIndex, onClick, isMobile = false, unfeaturedCount = 0 }) => (
  <div className={`relative flex-shrink-0 ${isMobile ? 'w-20' : 'w-full'}`}>
    <div 
      className={`group relative flex flex-col items-center justify-center ${
        isMobile ? 'w-20 h-20' : 'w-full aspect-square'
    ...
    >
      ...
      >
        <div
          className={`relative ${isMobile ? 'h-8 w-8' : 'h-12 w-12'} mb-1 transition-all duration-300 ${
            selectedIndex === index 
    ...
    if (selectedCategoryIndex === 0) {
      ...
      sortedCategories.forEach(category => {
        ...
        if (category !== othersCategory) {
          const categoryFeaturedGames = featuredGames.filter(game => game.categories.includes(category));
      ...
      return {
        [selectedCategory.name]: gamesPerCategory[selectedCategory.category]?.displayed || []
      };
    }
  };
    ...
    <div className="w-full mx-auto pt-2 pb-3 sm:py-5">
      ...
      <div className="w-full pt-2 md:pt-4 relative mb-3 md:mb-6">
        <div className="hidden md:block">
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 xl:grid-cols-9 2xl:grid-cols-11 gap-2 sm:gap-3 md:gap-4">
