...
import controller_img from "../../../assets/chip.png";
  ...
  return (
    <div className="relative mx-[10px] mb-4 mt-3">
      <div className="relative">
        <input
          type="text"
          placeholder={t.searchPlaceholder || 'Search casino games...'}
          value={searchTerm}
...
const CasinoGamesContent = () => {
  ...
  // Filter games to show only casino games (check categories array)
  const casinoGames = games.filter(game => 
    game.categories && game.categories.some(cat => cat.toLowerCase() === 'ক্যাসিনো')
  );
  ...
  // Get providers that actually have casino games
  const availableProviders = providers.filter(provider => 
    casinoGames.some(game => game.providerName === provider.providerName)
  );
    ...
    <div className="container mx-auto pt-2 pb-3 sm:py-5">
            ...
            searchTerm && selectedProvider 
              ...
              : searchTerm 
                ...
                : selectedProvider 
                  ...
                  : t.allCasinoGames // Updated to use new translation key
          } 
      ...
      {!hasMoreGames && filteredGames.length > 0 && (
        <div className="text-center py-6 text-teal-400">
          <p>{t.allGamesLoaded || 'All casino games loaded'}</p>
        </div>
      )}
    </div>
  );
...
// Main Casinogames Page Component
const Casinogames = () => {
