...
const Activeuser = () => {
  ...
  const fetchActiveUsers = async () => {
    try {
      const response = await axios.get(`${base_url}/admin/active-users`, {  
        headers: {
          ...
          <div className="w-full p-4">
            ...
            <div className="flex flex-wrap gap-4 mb-6 text-gray-700">
              ...
              <button 
                ...
                className="self-end ml-2 px-4 py-2 bg-cyan-600 text-white rounded-[3px] hover:bg-cyan-700"
              >
                Reset Filters
              </button>
            </div>
            ...
            <div className="mb-4 text-sm text-gray-600">
              Showing {filteredUsers.length === 0 ? 0 : indexOfFirstUser + 1}-{Math.min(indexOfLastUser, filteredUsers.length)} of {filteredUsers.length} active users
            </div>
              ...
              <table className="w-full border-collapse shadow-xl bg-white  overflow-hidden">
                <thead>
                  <tr className="bg-cyan-600 text-white">
                    ...
                    <th className="py-3 px-4 text-left">Referral Earnings</th>
                  ...
                  {currentUsers.length > 0 ? (
                    currentUsers.map((user, index) => (
                      <tr key={index} className="border-b even:bg-gray-50">
                        ...
                        <td className="py-3 px-4 text-gray-800 font-[600]">৳{user?.referralEarnings || 0}</td>
